...
def weatherview(request):
    ...
    "https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode="+ zipcode +"&distance=25&API_KEY=D39AFB03-CEE4-49E3-BB38-C13BFFA6D40B")
        try:
        ...
        if api[0]['Category']['Name'] == "Good":
            ...
            category_description = "(01 to 150) Members of sensitive groups may experience health effects. The general public is less likely to be affected."
            category_color = "usg"
        ...
        return render(request, 'weather.html', {'api': api, 'category_description': category_description, 'category_color': category_color})
    else:
        api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=73159&distance=25&API_KEY=D39AFB03-CEE4-49E3-BB38-C13BFFA6D40B")
